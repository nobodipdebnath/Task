...
const ProfessionalChallenge = () => {
    ...
    <div className="chat md:px-[100px] pb-[120px]">
      ...
      <div className="flex items-center justify-end gap-2 mt-[10%]">
        <p className="text-lg text-[#FAFAFD]">Professional Challenge</p>
        <img
      ...
      <div className="flex items-center gap-3 mt-11">
        ...
        <p className="text-[#FAFAFD] text-lg">
          What has been going on in your professional life that I can help you explore?
        </p>
      </div>
      <h1 className="text-start  text-base mt-11 py-5 px-8  bg-primary1 text-[#2D2D2D] rounded-xl">
        I successfully completed a project ahead of schedule with positive feedback. This win boosted my confidence, validated my effort, and reinforced that perseverance leads to meaningful professional achievements.
      </h1>
...
export default ProfessionalChallenge;