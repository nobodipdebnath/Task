...
const StartChat = () => {
    return (
        <div className='chat md:px-[200px] pb-[120px]'>
            <h1 className='text-white text-center mt-10 md:mt-10 text-5xl lg:text-[96px] league-gothic'>Start a New Chat</h1>
            <h3 className='text-white text-center text-5xl lg:mt-[50vh] mt-[90%] league-gothic'>What can I help with?</h3>
