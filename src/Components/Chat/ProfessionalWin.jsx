...
const ProfessionalWin = () => {
    ...
    <div className="chat md:px-[100px] pb-[120px]">
      ...
      <div className="flex items-center justify-end gap-2 mt-[10%]">
        <p className="text-lg text-[#FAFAFD]">Professional Win</p>
        <img
      ...
      <h1 className="text-start  text-base mt-11 py-5 px-8  bg-primary1 text-[#2D2D2D] rounded-xl">
        Managing increasing responsibilities at work has been demanding. It pushes me to improve time management, delegation, and resilience, while reminding me growth often comes through overcoming tough challenges.
      </h1>
...
export default ProfessionalWin;